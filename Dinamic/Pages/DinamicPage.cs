    ...
    public class DinamicPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            if (Content == null)
            {
                ...
                this.ToolbarItems.Add(new ToolbarItem() { Text = "Documento", Order = ToolbarItemOrder.Primary, Command = new Command(ToolbarItemDocumentCommand), CommandParameter = "1" });
        ...
        private async void ToolbarItemCommand()
        {
           ...
           //executa o processo de gravacao
            ...
            Application.Current.MainPage.DisplayAlert("Dados Validados!", cMsg, "OK");


        }


        private async void ToolbarItemDocumentCommand()
        {
            this.Navigation.PushAsync(new DocumentPage());
        }
